...
const TeamLeaderPage = () => {
  ...
  return (
    <div className="p-8 font-sans bg-soft-gray min-h-screen">
      <h1 className="text-4xl font-bold mb-6 text-navy">Team Leader View</h1>
      <p className="text-lg mb-8 text-navy">Welcome to your personalized Team Leader Landing Page.</p>
      <button 
