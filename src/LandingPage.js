...
<h1 className="text-5xl font-bold mb-8 text-navy">ContactVantage</h1>
  <div className="max-w-3xl text-center mb-12">
    ...
    <p className="mb-8">
      The key concept of this solution is to NOT stop after using AI to generate valuable actionable insight, but to create a system that all user persona's can interact with. This system allows for the automation of closed loop action and completes the system vs merely generating insight. This system can also be evolved easily with revolving requirements. 
    </p>
    <p className="mb-8">
